...
import { Sparkles, AlertCircle, ArrowRight, Lock, Mail, Eye, EyeOff } from 'lucide-react';
...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (!isAuthLoading && user && !isRedirecting.current) {
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="bg-slate-900/80 border border-slate-800/80 rounded-2xl p-8 backdrop-blur-xl shadow-xl shadow-black/40">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-10 pr-10 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 transition-all text-sm"
          ...
          <div className="mt-6 pt-6 border-t border-slate-800/80 text-center text-sm text-slate-400">
            ...
            <Link href="/register" className="font-medium text-emerald-400 hover:text-emerald-300 underline underline-offset-4 transition-colors">
              Create an account
            </Link>
          </div>
        </div>
